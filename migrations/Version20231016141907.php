 ...
 */
final class Version20231016141907 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cocktails (id INT NOT NULL, name VARCHAR(100) NOT NULL, price DOUBLE PRECISION NOT NULL, vip BOOLEAN NOT NULL, slug VARCHAR(100) NOT NULL, PRIMARY KEY(id))');
